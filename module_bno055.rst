...
| 12     |             |                |               | Порядок байт - **little endian**                               |
+--------+-------------+----------------+---------------+----------------------------------------------------------------+
| 13     | acc_x       | uint16_t       | 0xXX          | Линейное ускорение по оси X. 1 м/с2 - 100 LSB                 |
+--------+             +                +               +                                                                +
| 14     |             |                |               | Порядок байт - **little endian**                               |
+--------+-------------+----------------+---------------+----------------------------------------------------------------+
| 15     | acc_y       | uint16_t       | 0xXX          | Линейное ускорение по оси Y. 1 м/с2 - 100 LSB                  |
+--------+             +                +               +                                                                +
| 16     |             |                |               | Порядок байт - **little endian**                               |
+--------+-------------+----------------+---------------+----------------------------------------------------------------+
| 17     | acc_z       | uint16_t       | 0xXX          | Линейное ускорение по оси Z. 1 м/с2 - 100 LSB                  |
+--------+             +                +               +                                                                +
